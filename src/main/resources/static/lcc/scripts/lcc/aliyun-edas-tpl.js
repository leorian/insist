angular.module('aliyun.console.lcc.tpl', ['scripts/lcc/views/app/app.html', 'scripts/lcc/views/app/appLogs.html', 'scripts/lcc/views/app/basicInfo.html', 'scripts/lcc/views/app/basicMonitor.html', 'scripts/lcc/views/app/consumedService.html', 'scripts/lcc/views/app/consumerList.html', 'scripts/lcc/views/app/degradeRule.html', 'scripts/lcc/views/app/detail.html', 'scripts/lcc/views/app/flowControl.html', 'scripts/lcc/views/app/interface.html', 'scripts/lcc/views/app/methodList.html', 'scripts/lcc/views/app/opLogDetail.html', 'scripts/lcc/views/app/opLogs.html', 'scripts/lcc/views/app/publishedService.html', 'scripts/lcc/views/app/realLog.html', 'scripts/lcc/views/app/serviceList.html', 'scripts/lcc/views/app/softwareVersion.html', 'scripts/lcc/views/home.html', 'scripts/lcc/views/resource/ecs.html', 'scripts/lcc/views/resource/group.html', 'scripts/lcc/views/resource/rds.html', 'scripts/lcc/views/resource/resources.html', 'scripts/lcc/views/resource/slb.html', 'scripts/lcc/views/resource/vpc.html', 'scripts/lcc/partials/common/lccFormDialog.html', 'scripts/lcc/partials/common/lccRegionBar.html', 'scripts/lcc/partials/common/lccSingleChart.html', 'scripts/lcc/partials/common/lccSliderDiv.html', 'scripts/lcc/partials/common/lccTextDialog.html', 'scripts/lcc/partials/common/verifyCode.html', 'scripts/lcc/partials/resource/addEcs.html', 'scripts/lcc/partials/resource/agentInstall.html', 'scripts/lcc/partials/resource/bindEcs.html', 'scripts/lcc/partials/resource/bindSlb.html', 'scripts/lcc/partials/resource/createGroup.html', 'scripts/lcc/partials/resource/createSnapshot.html', 'scripts/lcc/partials/resource/ecsTip.html']);
...
angular.module("scripts/lcc/views/home.html", []).run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("scripts/lcc/views/home.html",
    "<div><div class=\"row\"><div class=\"col-sm-12\"><div class=\"console-title clearfix\"><div class=\"row\" style=\"margin-bottom:16px\"><div aliyun-console-global-notice=\"\" product-id=\"ecs\" class=\"col-md-12\"></div></div><div class=\"pull-left\"><h5>概览</h5></div></div><div ng-if=\"home.add_show\"><div class=\"summary-total\"><a ng-if=\"home.isPaid\" class=\"btn btn-default margin-right pull-right ng-scope\" target=\"_blank\" style=\"margin-top: 4px\" ng-click=\"home.buyLinkUpgrade()\"><span class=\"icon-renew-mgt\"></span> <span>升级管理</span></a> <a ng-if=\"home.isPaid\" class=\"btn btn-default margin-right pull-right ng-scope\" target=\"_blank\" style=\"margin-top: 4px\" ng-click=\"home.buyLinkRenew()\"><span class=\"icon-renew-mgt\"></span> <span>续费管理</span></a><div>套餐类型：<span style=\"color:#FF9900\">{{home.version}}</span><span ng-if=\"home.version&&home.version!='公测'\">，最大支持&nbsp;<span style=\"color:#00A2CA\">{{home.ordercount}}</span>&nbsp;个应用节点；<span style=\"color:#00A2CA\">{{home.endtime | date}}</span>&nbsp;到期</span><!--a class=\"btn btn-default margin-right pull-right\" style=\"margin:5px;\">\n" +
    "                            <span class=\"icon-setup\"></span> 变更配置\n" +
    "                        </a--></div><div>运行概况：您共有ECS资源 &nbsp; <span style=\"color:#00A2CA\">{{home.ecsNum}}</span>&nbsp; 台，其中&nbsp; <span style=\"color:#00A2CA\">{{home.ecsAgentNum}}</span>&nbsp;台已安装LCC Agent，共有应用 &nbsp; <span style=\"color:#00A2CA\">{{home.appNum}}</span>&nbsp; 个，共部署于 &nbsp; <span style=\"color:#00A2CA\">{{home.ecsDeployNum}}</span>&nbsp; 台 ECS实例上。<span style=\"color:#FF9900\"></span></div></div><div lcc-action-auth auth=\"15:2\"><div class=\"col-sm-6 rds-dashboard-chart ng-scope\" style=\"margin-top: 20px;padding-left: 0px\" ng-repeat=\"chart in home.charts\"><div class=\"simple-chart\"><div class=\"simple-chart-head\"><div class=\"simple-chart-head-title\"><a ui-sref=\"lccDetail.basicInfo({appId:chart.appId,appName:chart.appName})\">{{chart.appName}}</a></div><div class=\"simple-chart-operations\"><div class=\"simple-chart-btn\" ng-click=\"home.deleteCollect(chart)\"><span class=\"icon-no\"></span></div></div></div><div class=\"simple-chart-body\" ng-hide=\"settings.showNoData\" style=\"height: 241px\"><div class=\"simple-chart-body-inner\" ecs-chart chart-title=\"\" config=\"chart\"></div></div></div></div><div class=\"col-sm-6 rds-dashboard-chart ng-scope\" data-spm=\"92\" style=\"margin-top: 20px;padding-left: 0px\"><div class=\"rds-dashboard-add-container full-wrapper\" config-array=\"configArray\" rds-dashboard-add=\"\"><span class=\"rds-dashboard-add\" ng-click=\"home.addApp()\"></span> <span config-array=\"configArray\" rds-dashboard-left=\"\"><span class=\"rds-dashboard-add-tips text-muted\"><span text-plain=\"\" type=\"tips\" text=\"addChart.tip1\">您当前还可以添加个</span> <span class=\"text-warning\">{{home.quota}}</span> <span text-plain=\"\" type=\"tips\" text=\"addChart.tip2\">监控图。</span></span></span></div></div></div></div><div ng-hide=\"home.add_show\" aliyun-loading size=\"48\" style=\"margin-top: 100px\"></div><div class=\"helper-link-footer ng-scope col-sm-12\"><h5 class=\"inline-block margin-left-2\">使用帮助:</h5><a ng-repeat=\"docLink in home.docLinks\" class=\"inline-block lcc-helper-link ng-scope ng-binding\" href=\"{{docLink.docUrl}}\" target=\"_blank\" muse_scanned=\"true\">{{docLink.docName}}</a></div><div class=\"col-sm-12 lcc-version\"><p>© 2009-2015 Aliyun.com &nbsp;&nbsp;&nbsp;版本号:<a href=\"{{home.lccReleasenote}}\" target=\"_blank\" muse_scanned=\"true\">{{home.lccVersion}}</a></p></div></div></div></div>");
}]);
